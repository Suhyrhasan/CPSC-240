...
#Program: Validate Integer Input 2.0
#Author: F. Holliday
...
echo "Bash: Assemble vviewstack.asm"
nasm -f elf64 -o view.o viewstack.asm

echo "Bash: Link the object files"
g++ -m64 -fno-pie -no-pie -o code.out -std=c++17 scan.o valid.o drive.o atol.o view.o
